...
```{R}
fert_dat <- read.csv("children_per_woman_total_fertility.csv")
CO2_dat <- read.csv("consumption_emissions_tonnes_per_person.csv")
GDP_dat <- read.csv("gdppercapita_us_inflation_adjusted.csv")
life_dat <- read.csv("life_expectancy_years.csv")
